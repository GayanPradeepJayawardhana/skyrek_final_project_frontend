    ...
    return (
        <>
            <header className="w-full h-[100px] bg-accent flex justify-center lg:justify-between p-6">
                <Link to="/">
                    <img src="/logo-white.png" className="h-full" alt="Logo" />
                </Link>
                ...
                <div className="justify-center items-center gap-4 hidden lg:flex">
                    <Link
                        to="/cart"
                        className="h-full flex justify-center items-center text-white hover:text-gray-500 px-4"
                    >
                        <BiCart size={24} />
                    </Link>
                    <UserData />
            ...
            <div className="fixed bottom-0 left-0 w-full h-[80px] bg-white shadow-2xl flex lg:hidden justify-evenly items-center z-50">
                <Link
                    to="/"
                    className="h-full flex flex-col justify-center items-center text-accent text-3xl"
                >
                    <IoHomeOutline />
